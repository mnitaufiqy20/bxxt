...
Calendar.prototype.getMonthlyCalendarCode = function() {
    ...
    vCode = vCode + "<tbody style={font-family:宋体;font-size:9pt; COLOR: black;height:20px}>"
    vHeader_Code = this.cal_header();
    vData_Code = this.cal_data();
    vCode = vCode + vHeader_Code + vData_Code;

    vCode = vCode + "</tbody></TABLE>";
...
Calendar.prototype.show = function() {
    ...
    this.wwrite("<TABLE  BORDER=1 CELLSPACING=0 CELLPADDING=0 BGCOLOR='#e0e0e0'  ><tbody style={font-family:宋体;font-size:9pt; COLOR: black}><TR><TD width=19%   ALIGN=center>");
    this.wwrite("<A HREF=\"" +
                "javascript:window.opener.Build(" +
                "'" + this.gReturnItem + "', '" + this.gMonth + "', '" + (parseInt(this.gYear) - 1) + "', '" + this.gFormat + "'" +
                ");" +
                "\"><<<\/A></TD><TD width=19%  ALIGN=center>");
    this.wwrite("<A HREF=\"" +
                "javascript:window.opener.Build(" +
                "'" + this.gReturnItem + "', '" + prevMM + "', '" + prevYYYY + "', '" + this.gFormat + "'" +
                ");" +
                "\"><<\/A></TD><TD ALIGN=center width=19% >");
    this.wwrite("<A HREF=\"" +
                "javascript:window.opener.Build(" +
...
Calendar.prototype.showY = function() {
    ...
    this.wwrite("<TABLE  BORDER=1 CELLSPACING=0 CELLPADDING=0 BGCOLOR='#e0e0e0'><tbody style={font-family:宋体;font-size:9pt; COLOR: black;height:20px}><TR><TD ALIGN=center >");
    this.wwrite("[<A HREF=\"" +
                "javascript:window.opener.Build(" +
...
function getDateTime(key) {
    var vleft = event.clientX + screenLeft;
    var vright = event.clientY + screenTop;
    var url = "/WebLibary/js/dateTime.htm";
    var winstyle = "dialogWidth:360px;dialogHeight:250px;dialogLeft:" + vleft +
                   ";dialogTop:" + vright +
                   ";help:no;status:no;center:no;toolbar:no;menubar:no;resizable:no;scrollbars:yes";
    var retValue = window.showModalDialog(url, "", winstyle);
    var fd = eval('document.' + key);
    if (retValue) {
        if (retValue == " ") {
            fd.value = "";
        } else {
