...
*********   用途:时间日期调用函数
*********   用法:在第一个form中包含该函数
*********   示例：<input  type="text" name="test" onfocus="setday(this)" />
******************************************************/
...
document.writeln('        onclick="bltPrevM()" title="上月" Author=blt><b Author=blt>&lt;&lt;</b>');
...
document.writeln('         onclick="bltNextM()" title="下月" Author=blt><b Author=blt>&gt;&gt;</b></td></tr>');
...
document.writeln('          <tr><td Author=blt align=left><Label Author=blt title="上一年" onclick="bltPrevY()" ');
document.writeln('             onfocus="this.blur()">< </Label> <Label Author=blt title="上月" ');
...
document.writeln('             onfocus="this.blur()" title="当前年月">今 天</Label></td><td ');
document.writeln('             Author=blt align=right><Label Author=blt onclick="bltNextM()" ');
document.writeln('             onfocus="this.blur()" title="下月">>></Label> <Label ');
document.writeln('             Author=blt title="下一年" onclick="bltNextY()"');
