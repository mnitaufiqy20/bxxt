...
<body id="">
    <g:form id="gForm" name="gForm" action="flowConfigSave" controller="flowConfig" method="post">
        ...
        <table width="100%"  height="200" border="0" cellpadding="0" cellspacing="0">
            <tr height="30">
                <td colspan="5" align="center" ><h2>修改角色流程配置</h2></td>
            </tr>
            <tr height="80">
                                        ...
                                        <tr>
                                            <td colspan="8">
                                                <table width="100%" height="60"  border="1" cellpadding="0" cellspacing="0">
                                                    ...
                                                    <tr>
                                                        <td width="25%">
                                                            <input type="hidden" name="id" value="${exmApp.id}">
                                                            <input type="text" style="width: 100%;height: 100%" name="empRole" id="empRole" value="${exmApp.empRole}" disabled>
                                                        </td>
                                                        <td width="8%">
                                                            <input type="text" style="width: 100%;height: 100%" name="firstName" id="firstName" value="${exmApp.firstName}">
                                                        </td>
                                                        <td width="8%">
                                                            <input type="text" style="width: 100%;height: 100%" name="secondName" id="secondName" value="${exmApp.secondName}">
                                                        </td>
                                                        <td width="8%">
                                                            <input type="text" style="width: 100%;height: 100%" name="thirdName" id="thirdName" value="${exmApp.thirdName}">
                                                        </td>
                                                        <td width="8%">
                                                            <input type="text" style="width: 100%;height: 100%" name="fourthName" id="fourthName" value="${exmApp.fourthName}">
                                                        </td>
                                                        <td width="8%">
                                                            <input type="text" style="width: 100%;height: 100%" name="fifthName" id="fifthName" value="${exmApp.fifthName}">
                                                        </td>
                                                        <td width="8%">
                                                            <input type="text" style="width: 100%;height: 100%" name="postAcc" id="postAcc" value="${exmApp.postAcc}">
                                                        </td>
                                                        <td width="10%">
                                                            <input type="text" style="width: 100%;height: 100%" name="payTeller" id="payTeller" value="${exmApp.payTeller}">
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
