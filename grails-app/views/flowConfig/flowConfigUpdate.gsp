                                                ...
                                                <table width="100%" height="60"  border="1" cellpadding="0" cellspacing="0">
                                                    ...
                                                    <tr>
                                                        <td width="25%">
                                                            ...
                                                            <input type="text" style="width: 100%;height: 100%" name="empRole" value="${exmApp.empRole}" disabled>
                                                        </td>
                                                        <td width="8%">
                                                            <input type="text" style="width: 100%;height: 100%" name="firstName" value="${exmApp.firstName}">
                                                        </td>
                                                        <td width="8%">
                                                            <input type="text" style="width: 100%;height: 100%" name="secondName" value="${exmApp.secondName}">
                                                        </td>
                                                        <td width="8%">
                                                            <input type="text" style="width: 100%;height: 100%" name="thirdName" value="${exmApp.thirdName}">
                                                        </td>
                                                        <td width="8%">
                                                            <input type="text" style="width: 100%;height: 100%" name="fourthName" value="${exmApp.fourthName}">
                                                        </td>
                                                        <td width="8%">
                                                            <input type="text" style="width: 100%;height: 100%" name="fifthName" value="${exmApp.fifthName}">
                                                        </td>
                                                        <td width="8%">
                                                            <input type="text" style="width: 100%;height: 100%" name="postAcc" value="${exmApp.postAcc}">
                                                        </td>
                                                        <td width="10%">
                                                            <input type="text" style="width: 100%;height: 100%" name="payTeller" value="${exmApp.payTeller}">
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
