...
<body id="content">
<g:form action="login" controller="userLogin" method="post">
            ...
            <td width=195 height=90 background=../images/login/login_2.gif>
                <table width=190 height=60 border="0" align=center cellpadding=2 cellspacing=0>
                    ...
                    <tr>
                        ...
                        <td>
                            <g:textField name="loginName" value="" style="width: 130px;" maxlength="30"/>
                        </td>
                    </tr>
                    <tr>
                        <td height=10></td>
                    ...
                    <tr>
                        ...
                        <td>
                            <g:passwordField name="userPwd" value="" style="width: 130px;" maxlength="30"/>
                        </td>
