...
//            var flag = dataFlagV();
//            alert(flag);
//            alert("deG:"+$("#dataFlag").text());
            if(checkBudgetYear()){
                var gForm = document.getElementById("gForm");
                gForm.action = "budgetReportReceiptsSave";
...
<table width="100%"  height="200" border="0" cellpadding="0" cellspacing="0">
                                    ...
                                    <table width="100%">
                                        <tr  width="100%">
                                            ...
                                            <g:if test="${budgetReportReceipts1==null}">
                                                <td height="30" width="16%">
                                                    %{--系统自动带入--}%
                                                    <input type="text" id="budgetCompanyNo" name="budgetCompanyNo" value="${user.companyNo}" readonly>
                                                </td>
                                            </g:if>
                                            <g:else>
                                                <td height="30" width="16%">
                                                    %{--系统自动带入--}%
                                                    <input type="text" id="budgetCompanyNo2" name="budgetCompanyNo" value="${budgetReportReceipts1.budgetCompanyNo}" readonly>
                                                </td>
                                            </g:else>
                                            ...
                                            <g:if test="${budgetReportReceipts1==null}">
                                                <td height="30" width="16%">
                                                    %{--系统自动带入当前登录人信息--}%
                                                    <input id="budgetReportEmpNo" name="budgetReportEmpNo" type="text" value="${user.empNo}" readonly>
                                                </td>
                                            </g:if>
                                            <g:else>
                                                <td height="30" width="16%">
                                                    %{--系统自动带入当前登录人信息--}%
                                                    <input id="budgetReportEmpNo2" name="budgetReportEmpNo" type="text" value="${budgetReportReceipts1.budgetReportEmpNo}" readonly>
                                                </td>
                                            </g:else>
                                        ...
                                        <tr>
                                            ...
                                            <g:if test="${budgetReportReceipts1==null}">
                                                <td height="30">
                                                    %{--系统自动带入--}%
                                                    <input id="budgetDepartmentNo" name="budgetDepartmentNo" type="text" value="${user.departmentNo}" readonly>
                                                </td>
                                            </g:if>
                                            <g:else>
                                                <td height="30">
                                            ...
                                            %{--系统自动带入--}%
                                            <g:if test="${budgetReportReceipts1==null}">
                                                <td><input id="budgetReportEmpPosition" name="budgetReportEmpPosition" type="text" value="${user.empPosition}" readonly></td>
                                            </g:if>
                                            <g:else>
                                        ...
                                        <tr>
                                            ...
                                            %{--默认为当前年份--}%
                                            <g:if test="${budgetReportReceipts1==null}">
                                                <td height="30"><input id="budgetYear" name="budgetYear" type="text" value="${year}" class="Wdate" onclick="SelectDate(this,'yyyy',null,null);" onblur="checkBudgetYear();"></td>
                                            </g:if>
                                            <g:else>
                                            ...
                                            %{--系统自动带入--}%
                                            <g:if test="${budgetReportReceipts1==null}">
                                                <td><input id="budgetReportEmpName" name="budgetReportEmpName" type="text" value="${user.userName}" readonly></td>
                                            </g:if>
                                            <g:else>
    ...
    <tr>
        ...
        <td height="30">
            <g:if test="${budgetReportReceipts1==null}">
                <input type="button" value="保存" onclick="commForm();">
            </g:if>
            <g:else>
        ...
        <td>&nbsp;&nbsp;</td>
        <td><input type="button" value="退回"></td>
        %{--<input type="button" value="退回" onclick="location='../processes/initProcess'">--}%
        <g:if test="${budgetReportReceipts1==null}">
            <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
        </g:if>
        <g:else>
        ...
        <td>&nbsp;&nbsp;</td>
        %{--<input type="hidden" id="dataFlag" value="">--}%
...
<script type="text/javascript">
    function checkBudgetYear(){
        ...
        for(var i=0;i< s.length-1;i++){
            if(s[i]==name){
                alert("该年份已有预算申请单，请重新选择！");
                return false;
            }
        }
        return true;
//        $("#dataFlag").val("");
//        $.post("../budgetReportReceipts/checkBudgetYear",{name:name},function(data){
//            if(data=="true"){
////                $("#dataFlag").val("true");
//                $("#dataFlag").html("true");
//                alert("该年份已有预算申请单，请重新选择！");
